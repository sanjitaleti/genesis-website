 ...
 *  Every icon carries its own small continuous motion, baked into an
 *  inner element so it survives regardless of what className/style a
 *  call site passes to the outer <svg> (a plain object spread would
 *  otherwise clobber it). Motion is CSS-only — the site's global
 *  prefers-reduced-motion rule freezes all of it at once. */
...
/** Wraps children in a <g> that breathes gently — the default motion
 *  for icons with no more specific narrative (scale + opacity, low
 *  amplitude so a page full of icons never reads as busy). */
function Breathe({ duration = "3.4s", children }: { duration?: string; children: React.ReactNode }) {
  return (
    <g style={{ transformOrigin: "12px 12px", animation: `v2-breathe ${duration} ease-in-out infinite` }}>
      {children}
    </g>
  );
}

/** A path that draws itself in, holds, fades, and loops. */
function Draw({ d, len, delay = "0s" }: { d: string; len: number; delay?: string }) {
  return (
    <path
      d={d}
      style={{
        ...
        animation: `v2-draw 3.2s ease-in-out ${delay} infinite`,
      }}
    />
  );
}
...
export const IconChart = (p: P) => (
  <svg {...base} {...p}>
    ...
    <path
      d="M7.5 16.5v-4"
      style={{ transformOrigin: "7.5px 19.5px", animation: "v2-bar 1.6s ease-in-out infinite" }}
    />
    <path
      d="M12 16.5V7"
      style={{ transformOrigin: "12px 19.5px", animation: "v2-bar 1.6s ease-in-out infinite .2s" }}
    />
    <path
      d="M16.5 16.5v-6.5"
      style={{ transformOrigin: "16.5px 19.5px", animation: "v2-bar 1.6s ease-in-out infinite .4s" }}
    />
  </svg>
);
...
export const IconCheck = (p: P) => (
  <svg {...base} {...p}>
    <Draw d="M4.5 12.5 9.5 17.5 19.5 7" len={22} />
  </svg>
);

export const IconArrow = (p: P) => (
  <svg {...base} {...p}>
    <g style={{ animation: "v2-nudge-x 1.6s ease-in-out infinite" }}>
      <path d="M5 12h14" />
...
export const IconSend = (p: P) => (
  <svg {...base} {...p}>
    <g style={{ animation: "v2-nudge-x 1.7s ease-in-out infinite" }}>
...
export const IconPaperclip = (p: P) => (
  <svg {...base} {...p}>
    <Draw d="M20 11.5 12.3 19.2a4.4 4.4 0 0 1-6.2-6.2l7.9-7.9a2.9 2.9 0 0 1 4.1 4.1l-7.8 7.8a1.4 1.4 0 0 1-2-2l7.2-7.2" len={34} />
  </svg>
);

export const IconLink = (p: P) => (
  <svg {...base} {...p}>
    <Draw d="M10.3 13.7a3.6 3.6 0 0 0 5.4.4l2.5-2.5a3.6 3.6 0 0 0-5.1-5.1l-1.4 1.4" len={13} />
    <Draw d="M13.7 10.3a3.6 3.6 0 0 0-5.4-.4l-2.5 2.5a3.6 3.6 0 0 0 5.1 5.1l1.4-1.4" len={13} delay=".2s" />
  </svg>
);

export const IconCode = (p: P) => (
  <svg {...base} {...p}>
    <path style={{ animation: "v2-nudge-neg-x 2s ease-in-out infinite" }} d="m9 8-4.5 4L9 16" />
    <path style={{ animation: "v2-nudge-x 2s ease-in-out infinite" }} d="m15 8 4.5 4L15 16" />
  </svg>
);
...
export const IconMic = (p: P) => (
  <svg {...base} {...p}>
    ...
    <path
      d="M5.8 11.4a6.2 6.2 0 0 0 12.4 0"
      style={{ transformOrigin: "12px 11.4px", animation: "v2-pulse 2.4s ease-in-out infinite" }}
    />
    <path d="M12 17.6v3" />
  </svg>
);
...
export const IconShield = (p: P) => (
  <svg {...base} {...p}>
    ...
    <Draw d="m9.3 12.2 1.9 1.9 3.6-3.7" len={9} />
  </svg>
);
...
export const IconClock = (p: P) => (
  <svg {...base} {...p}>
    ...
    <g style={{ transformOrigin: "12px 12px", animation: "v2-spin 5s linear infinite" }}>
...
export const IconPhone = (p: P) => (
  <svg {...base} {...p}>
    <g style={{ transformOrigin: "12px 12px", animation: "v2-ring 3.6s ease-in-out infinite" }}>
...
export const IconReport = (p: P) => (
  <svg {...base} {...p}>
    ...
    <path
      d="M8.6 16.4v-2.8"
      style={{ transformOrigin: "8.6px 16.4px", animation: "v2-bar 1.6s ease-in-out infinite" }}
    />
    <path
      d="M12 16.4v-5"
      style={{ transformOrigin: "12px 16.4px", animation: "v2-bar 1.6s ease-in-out infinite .2s" }}
    />
    <path
      d="M15.4 16.4v-1.6"
      style={{ transformOrigin: "15.4px 16.4px", animation: "v2-bar 1.6s ease-in-out infinite .4s" }}
    />
  </svg>
);
...
export const IconGear = (p: P) => (
  <svg {...base} {...p}>
    <g style={{ transformOrigin: "12px 12px", animation: "v2-spin 9s linear infinite" }}>
      <circle cx="12" cy="12" r="2.9" />
...
export const IconBell = (p: P) => (
  <svg {...base} {...p}>
    <g style={{ transformOrigin: "12px 6px", animation: "v2-ring 3.2s ease-in-out infinite" }}>
...
export const IconTrend = (p: P) => (
  <svg {...base} {...p}>
    <Draw d="m3.6 16.4 5-5.2 3.4 3.2 5-5.6" len={20} />
...
export const IconChevron = (p: P) => (
  <svg {...base} {...p}>
    <path style={{ animation: "v2-nudge-x 1.4s ease-in-out infinite" }} d="m9.5 6 6 6-6 6" />
  </svg>
);
...
export const IconDownload = (p: P) => (
  <svg {...base} {...p}>
    <g style={{ animation: "v2-nudge-y 1.7s ease-in-out infinite" }}>
      <path d="M12 4v11" />
...
/** Google's mark — brand colors, not our palette. Left static on purpose. */
...
export const IconBadgeCheck = (p: P) => (
  <svg {...base} {...p}>
    ...
    <Draw d="m8.7 12.3 2.2 2.2 4.4-4.7" len={10} />
  </svg>
);
